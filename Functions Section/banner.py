def banner_text(text: str = " ", screen_width: int = 80) -> None:
    """
    Prints a string centred, with ** either side

    Takes in the `text` and `screen_width` to define the size of
    the text formatting
    ...
    :param screen_width: Overall width to print within, including the 4
