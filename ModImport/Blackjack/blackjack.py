...
# dealing cards to the players each time the button is clicked
def deal_card(frame):
    # pop the next card off the top of the deck
    next_card = deck.pop(0)  # the card that the player is gonna get, so removing that card
...
# Changing background colour of the mainWindow
...
deck = list(cards)  # Creating a new list from the cards
random.shuffle(deck)
